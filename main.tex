...
\begin{lstlisting}
https://github.com/Y.Nagarani/Assignment4/tree/main/Assignment4
\end{lstlisting}
%
...
Find the zero's of the polynomial $x^2-3$ and verify the relationship between the zero's and the coefficients
%
\section{SOLUTION}  
Given
\begin{align}
...
\end{align}
a = 1 , b = 0 , c = 0 , d = 0 , e = $\frac{-1}{2}$ , f = -3
\\
Here,
\begin{align}
...
\begin{align}
\myvec{0 & -1 \\ 1 & 0 \\ 0 & 0}\vec{c} &= \myvec{3 \\ 0 \\ 0} \\
...
Now,
\begin{align}
\vec{p_1}^T\vec{c} &= \myvec{0 & 1}\myvec{0\\-3}
\\
&= -3
\end{align}
and,
...
$\because$
\begin{align}
(\vec{p_1}^T\vec{c})(\vec{p_2}^T\vec{V}\vec{p_2}) = -3<0
\end{align}
