...
x= \sqrt{3}
\end{align}
The roots are $\alpha$ = $\sqrt{3}$ and $\beta$ = $-\sqrt{3}$.
\\
Compare given quadratic equation  $x ^2 -3 = 0$ with $ux^2 + vx + f = 0$,we get
\\
u=1 , v=0 , f= -3.
\\
Sum of the roots
\begin{align} 
\alpha + \beta = \frac{-v}{u} = 0
\end{align}
product of the roots 
\begin{align}
\alpha\beta = \frac{f}{u} = -3
\end{align}
where u,v,f are parameters.
\\
For $\vec{x} = \myvec{\sqrt{3} \\ 0}$ substitute in (2.0.2)
\begin{align}
\myvec{\sqrt{3} & 0} \myvec{1 & 0 \\ 0 & 0}\myvec{\sqrt{3} \\ 0} -3 = 0
\end{align}
For $\vec{x} = \myvec{-\sqrt{3} \\ 0}$ substitute in (2.0.2)
\begin{align}
\myvec{-\sqrt{3} & 0} \myvec{1 & 0 \\ 0 & 0} \myvec{-\sqrt{3} \\ 0} -3 = 0
\end{align} 
Hence , $+\sqrt{3}$ and $-\sqrt{3}$ are zeros .
